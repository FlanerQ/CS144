...
void Router::route_one_datagram(InternetDatagram &dgram) {
    ...
    // match the route and the TTL is greater than 1 (TTL means the number of hops datagram can travel)
    if (best_match_it != _forward_table.end() && dgram.header().ttl > 1) {
        ...
        // if the destination network is directly attached to the router, the next hop is the destination IP addr.
        // otherwise it is the IP addr of the next hop router
